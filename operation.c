...
void print_line(int line_no , char *filename)
{
...
void print_alternate_lines(char *filename)
{
...
{
print_line(1+i , filename);
print_line(line_count -i , filename);
}
if(line_count % 2 != 0)
{
 
print_line((line_count + 1) /2 , filename);
}
fclose(file);
